...
haou = HR_ALL_ORGANIZATION_UNITS.selectExpr("substring(value, 6) as value") \
    .select(from_avro(col("value"), schema_hr).alias("haou")) \
        .select("haou.ORGANIZATION_ID") \
            .filter("haou.BUSINESS_GROUP_ID = 21")
...
#         .format("jdbc") \
#         .option("url", f"jdbc:sqlserver://2.92.26.184:1433;databaseName={database};") \
...
query = joining_result \
            ...
            .format("kafka") \
            .option("kafka.bootstrap.servers", "2.92.26.188:29093") \
            .option("checkpointLocation", "checkpoint-location-11") \
